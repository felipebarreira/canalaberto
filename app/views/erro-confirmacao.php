					...
					<div class="row justify-content-center">
						<div class="col-md-10">
							...
							<div class="row align-items-center">
								<div class="col-md-4">
									<lottie-player src="https://assets10.lottiefiles.com/packages/lf20_gu5zubdo.json" background="transparent" speed="1" style="width: 100%; height: 200px;" autoplay></lottie-player>
								</div>
								<div class="col-md-6">
									<h1>Canal Aberto</h1>
									<h2>ERRO AO CADASTRAR RELATO</h2>

									<p style="font-size: 2rem;">
										Ocorreu um erro ao cadastrar seu relato. <br>
										<a href="<?php echo HTTP_DOMAIN; ?>">Tente novamente</a> em alguns instantes.
									</p>
